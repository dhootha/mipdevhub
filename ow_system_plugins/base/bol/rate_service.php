...
final class BOL_RateService
{
    ...
    {
        $arr = $this->rateDao->findMostRatedEntityList($entityType, $first, $count);
    ...
    public function findMostRatedEntityCount( $entityType )
    {
        return $this->rateDao->findMostRatedEntityCount($entityType);
    }
