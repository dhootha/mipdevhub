...
class BASE_CTRL_ComponentPanel extends OW_ActionController
{
    ...
    public function myProfile( $paramList )
    {
        ...
        $cmp = OW::getEventManager()->call('class.get_instance', array(
            'className' => 'BASE_CMP_ProfileActionToolbar',
            'arguments' => array($userId)
        ));

        $cmp = $cmp === null ? new BASE_CMP_ProfileActionToolbar($userId) : $cmp;
    ...
    public function profile( $paramList )
    {
        ...
        $cmp = OW::getEventManager()->call('class.get_instance', array(
            'className' => 'BASE_CMP_ProfileActionToolbar',
            'arguments' => array($userDto->id)
        ));

        $cmp = $cmp === null ? new BASE_CMP_ProfileActionToolbar($userDto->id) : $cmp;
