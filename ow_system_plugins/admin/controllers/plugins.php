...
class ADMIN_CTRL_Plugins extends ADMIN_CTRL_Abstract
{
    ...
    public function processAdd()
    {
        ...
        $ftp->uploadDir($localDir, OW_DIR_PLUGIN . $innerDir);
    ...
    public function updateRequest( array $params )
    {
        ...
        $remotePluginInfo = (array) $this->pluginService->getPluginInfoForUpdate($pluginDto->getKey(), $pluginDto->getDeveloperKey());
    ...
    public function update( array $params )
    {
        ...
        try
        {
            $archivePath = $this->pluginService->downloadPlugin($pluginDto->getKey(), $pluginDto->getDeveloperKey(), (!empty($params['licenseKey']) ? $params['licenseKey'] : null));
        }
        catch ( Exception $e )
        {
