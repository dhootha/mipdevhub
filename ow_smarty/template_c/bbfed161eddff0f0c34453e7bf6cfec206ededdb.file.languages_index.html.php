<?php /* Smarty version Smarty-3.1.12, created on 2013-09-06 11:23:04
         compiled from "/apps/mip/oxwall/ow_system_plugins/admin/views/controllers/languages_index.html" */ ?>
<?php /*%%SmartyHeaderCode:302305001522a1d8844c507-48047094%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bbfed161eddff0f0c34453e7bf6cfec206ededdb' => 
    array (
      0 => '/apps/mip/oxwall/ow_system_plugins/admin/views/controllers/languages_index.html',
      1 => 1359700751,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '302305001522a1d8844c507-48047094',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522a1d8877d967_54240378',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522a1d8877d967_54240378')) {function content_522a1d8877d967_54240378($_smarty_tpl) {?><?php if (!is_callable('smarty_block_script')) include '/apps/mip/oxwall/ow_smarty/plugin/block.script.php';
...
if (!is_callable('smarty_modifier_escape')) include '/apps/mip/oxwall/ow_libraries/smarty3/plugins/modifier.escape.php';
...
', $contents: $('#new-key-form'), height: '380px', width: '550px', icon_class: 'ow_ic_add'})"><?php echo smarty_function_text(array('key'=>"admin+add_new_text"),$_smarty_tpl);?>
</a>
                </div>
