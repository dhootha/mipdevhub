<?php /* Smarty version Smarty-3.1.12, created on 2013-09-06 00:09:28
         compiled from "/apps/mip/oxwall/ow_system_plugins/base/views/controllers/join_index.html" */ ?>
<?php /*%%SmartyHeaderCode:147998035752297fa8ed3f63-57373670%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b9c2a65957353d1497e5f86d3577ee4605513785' => 
    array (
      0 => '/apps/mip/oxwall/ow_system_plugins/base/views/controllers/join_index.html',
      1 => 1365497567,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '147998035752297fa8ed3f63-57373670',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52297fa91d6204_75281240',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52297fa91d6204_75281240')) {function content_52297fa91d6204_75281240($_smarty_tpl) {?><?php if (!is_callable('smarty_block_block_decorator')) include '/apps/mip/oxwall/ow_smarty/plugin/block.block_decorator.php';
...
if (!is_callable('smarty_function_question_description_lang')) include '/apps/mip/oxwall/ow_smarty/plugin/function.question_description_lang.php';
...
?>
        ...
        <?php }?>
    <?php }?>
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('block_decorator', array('name'=>'box','iconClass'=>'ow_ic_user','langLabel'=>'base+join_form_title')); $_block_repeat=true; echo smarty_block_block_decorator(array('name'=>'box','iconClass'=>'ow_ic_user','langLabel'=>'base+join_form_title'), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_block_decorator(array('name'=>'box','iconClass'=>'ow_ic_user','langLabel'=>'base+join_form_title'), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
...
<?php }?> <?php if (empty($_smarty_tpl->tpl_vars['section']->value)){?>ow_tr_first<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['question']['last']&&$_smarty_tpl->tpl_vars['question']->value['name']!='password'){?>ow_tr_last<?php }?>">
                        <td class="ow_label">
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['question']->value['name']=='password'){?>
                        <tr class="<?php if (!empty($_smarty_tpl->tpl_vars['question']->value['trClass'])&&$_smarty_tpl->tpl_vars['question']->value['trClass']=='ow_alt1'){?>ow_alt2<?php }else{ ?>ow_alt1<?php }?> <?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['question']['last']){?>ow_tr_last<?php }?>">
                            <td class="ow_label">
